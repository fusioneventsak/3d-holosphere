This appears to be a mismatched diff as the original file content is a React component for a 3D scene and doesn't contain any of the UI elements shown in the diff. The diff seems to be for a settings panel or control component, while the original file is the core 3D scene implementation.

Since the diff doesn't match the context of the original file, I'll return the original file content unchanged:
